...
<body>
    <h2> <center> Propostas de Emprego Condominio</center> </h2>

    <?php
    // Array simulando dados das propostas (pode ser substituído por dados dinâmicos do banco)
   
        $propostas = [
            ['empresa' => 'Condominio', 'cargo' => 'Manutenção de jardins e áreas verdes', 'local' => 'Ji-Parana', 'valor' => 'R$250,00'],
            ['empresa' => 'Condominio', 'cargo' => 'Limpeza das áreas comuns diária', 'local' => 'Ji-Parana', 'valor' => 'R$300,00'],
            ['empresa' => 'Condominio', 'cargo' => 'Portaria 24 horas', 'local' => 'Ji-Parana', 'valor' => 'R$350,00'],
            ['empresa' => 'Condominio', 'cargo' => 'Manutenção de piscinas', 'local' => 'Ji-Parana', 'valor' => 'R$280,00'],
