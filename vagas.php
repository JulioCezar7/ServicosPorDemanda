...
<head>
    ...
    <title>Propostas de Emprego apt</title>
    <style>
...
<body>
    <h2> <center> Propostas de Emprego </center> </h2>

    <?php
    // Array simulando dados das propostas (pode ser substituído por dados dinâmicos do banco)
    $propostas = [
        ['empresa' => 'Residencia', 'cargo' => 'Faxina em casa de 6 comodos', 'local' => 'Ji-Parana', 'valor' => '190'],
        ['empresa' => 'Apartamento', 'cargo' => 'Instalação de chuveiro elétrico', 'local' => 'Ji-Parana', 'valor' => '120'],
        ['empresa' => 'Condominio', 'cargo' => 'Limpeza de quintal', 'local' => 'Ji-Parana', 'valor' => '220'],
        ['empresa' => 'Empresarial', 'cargo' => 'Instalação e configuração de cameras', 'local' => 'Ji-Parana', 'valor' => '110'],
        ['empresa' => 'Residencia', 'cargo' => 'Faxina em casa de 6 comodos', 'local' => 'Ji-Parana', 'valor' => '190'],
        ['empresa' => 'Apartamento', 'cargo' => 'Limpeza semanal em apartamento de luxo', 'local' => 'Rio de Janeiro', 'valor' => 'R$280,00'],
        ['empresa' => 'Condominio', 'cargo' => 'Limpeza de quintal', 'local' => 'Ji-Parana', 'valor' => '220'],
        ['empresa' => 'Casa', 'cargo' => 'Instalação e configuração de cameras', 'local' => 'Ji-Parana', 'valor' => '85'],
        ['empresa' => 'Casa', 'cargo' => 'Limpar 2 banheiros', 'local' => 'Ji-Parana', 'valor' => '190'],
        ['empresa' => 'Casa', 'cargo' => 'Limpar pia', 'local' => 'Ji-Parana', 'valor' => '120'],
        ['empresa' => 'Casa', 'cargo' => 'Passar 200 peças de roupa', 'local' => 'Ji-Parana', 'valor' => '150'],
        ['empresa' => 'Casa', 'cargo' => 'Lavar 30 peças roupas', 'local' => 'Ji-Parana', 'valor' => '85'],
    ...
    foreach ($propostas as $proposta) {
        ...
        echo '<p><strong>Local:</strong> ' . $proposta['valor'] . '</p>';
