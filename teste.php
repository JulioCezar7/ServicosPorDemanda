<?php
    if(isset($_POST['submit'])) 
    {
        ...
        $result = mysqli_query($conexao, "INSERT INTO usuario(nome, usuario, email, data_nascimento, senha) 
    ...
    if(isset($_POST['submit'])) 
    {
        ...
        // Verificar se o usuário e email já existem
    ...
    if(isset($_POST['submit'])) 
{
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // Se não existir, inserir os dados no banco de dados
    ...
    <div class="box">
        <form action="formulario.php" method="POST">
            <fieldset>
                ...
                <button onclick="redirectToLogin()" type="submit" name="submit" id="submit">Enviar</button>
                <br><br>
                <button onclick="redirectToLogin()" class="btn-cadastro">Tenho Login</button>
            </fieldset>
        </form>
    </div>
